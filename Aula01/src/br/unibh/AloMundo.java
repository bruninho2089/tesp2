...
public class AloMundo {
	...
	public static void main(String[] args) {
		...
		Aluno a1 = new Aluno(new Long(1), new Long (1234), "Danilo", "07158208699", new Date());
		Aluno a2 = new Aluno(new Long(2), new Long (5789), "Bruno", "10109906675", new Date());
		Aluno a3 = new Aluno(new Long(3), new Long (1357), "Gustavo", "321654987", new Date());
